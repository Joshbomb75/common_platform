...
def generate_launch_description():
    ...
    # Output goes directly to /rcr002/cmd_vel.
    # Velocity smoothing is handled in nine_move.py via ramp profile.
    # nav2_velocity_smoother will be added in Phase 2 when Nav2 lifecycle manager is present.
